...
class Today extends Component {
  ...
  _getChevron() {
    return (
        <Image
            style={{ width: 50, height: 50, opacity: .9, backgroundColor: 'transparent' }}
            source={{
             uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSqcuqd-7uiiSJ_BURD8Y5fRQ_NRY8Odgi0CNbYNbP9rbPB6GQFDw&s'
            }}
        />);
  }
    ...
    if (isHalfStaff) {
        return (
            <>
                ...
                <Text style={styles.sectionTitle}>{data.short}</Text>
    ...
    return (
        <>
            ...
            <Text style={styles.header}>
                The status of the American Flag today is FULL STAFF.
            </Text>
        </>
        );
  }
